    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative w-full h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-brand-navy z-0">
          <div className="absolute inset-0 opacity-30 bg-[url('https://images.unsplash.com/photo-1586528116311-ad8ed74514f4?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center"></div>
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Warehouse & Logistics <br/><span className="text-brand-blue">Security Solutions</span>
            </h1>
            <p className="text-lg text-slate-300 mb-8 max-w-2xl mx-auto font-medium">
              Protect inventory, secure loading docks, and monitor vast facility perimeters with our intelligent, scalable industrial security systems.
            </p>
            <button
              onClick={() => triggerQuoteModal('Warehouse Security Solutions')}
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center text-xs font-medium text-slate-500">
            ...
            <ChevronRight className="w-3.5 h-3.5 mx-1" />
            <span className="text-slate-900">Warehouse and Logistics</span>
          </div>
        </div>
      </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-brand-navy mb-4">Securing the Supply Chain</h2>
            <p className="text-slate-600 font-medium leading-relaxed">
              Logistics hubs face unique challenges: sprawling perimeters, high-volume vehicular traffic, and massive indoor storage areas that are difficult to patrol.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: 'Inventory Shrinkage', desc: 'Internal theft and lost packages cost the logistics industry billions annually.', icon: Package },
              { title: 'Perimeter Intrusions', desc: 'Vast, often poorly lit perimeters make warehouses easy targets for break-ins.', icon: ShieldCheck },
              { title: 'Dock Management', desc: 'Tracking and verifying trucks at loading docks is chaotic without automation.', icon: Truck },
            ].map((challenge, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            ...
            <p className="text-slate-600 font-medium max-w-2xl leading-relaxed">
              From the outer fence to the highest storage rack, we provide total visibility and access control.
            </p>
          </div>
            ...
            {[
              {
                ...
                icon: ShieldCheck,
                features: ['Thermal cameras', 'Active deterrence', 'Smart Intrusion Prevention']
              },
              {
                title: 'Dock & Yard Control',
                icon: Truck,
                features: ['ANPR for trucks', 'Driver facial recognition', 'Traffic flow heatmaps']
              },
              {
                title: 'Aisle Surveillance',
                icon: Box,
                features: ['Corridor mode cameras', 'Low-light ColorHunter', 'Forklift blind-spot monitoring']
              },
              {
                title: 'Inventory Tracking',
                icon: ScanLine,
                features: ['Barcode scanner integration', 'Video metadata search', 'Lost item retrieval']
              }
            ].map((cap, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="w-full md:w-1/2">
                <div className="relative h-[300px] md:h-[400px] rounded-3xl overflow-hidden shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?q=80&w=2070&auto=format&fit=crop" alt="Loading Docks" className="absolute inset-0 w-full h-full object-cover" />
                </div>
              </div>
              <div className="w-full md:w-1/2">
                ...
                <h3 className="text-2xl font-bold text-brand-navy mb-4">Loading Docks & Yards</h3>
                <p className="text-slate-600 font-medium leading-relaxed mb-6">
                  Automate entry for authorized freight trucks using our ANPR cameras while recording every loading sequence to dispute claims of damaged goods.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center gap-2 text-sm font-bold text-slate-700">
                    <CheckCircle2 className="w-4 h-4 text-brand-blue" /> Automatic Number Plate Recognition (ANPR)
                  </li>
                  <li className="flex items-center gap-2 text-sm font-bold text-slate-700">
                    <CheckCircle2 className="w-4 h-4 text-brand-blue" /> High-definition evidence for freight claims
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-12">
              <div className="w-full md:w-1/2">
                <div className="relative h-[300px] md:h-[400px] rounded-3xl overflow-hidden shadow-2xl">
                  <img src="https://images.unsplash.com/photo-1565891741441-64926e441838?q=80&w=2070&auto=format&fit=crop" alt="Warehouse Aisles" className="absolute inset-0 w-full h-full object-cover" />
                </div>
              </div>
              <div className="w-full md:w-1/2">
                <div className="w-12 h-12 bg-blue-50 text-brand-blue rounded-xl flex items-center justify-center mb-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-2 text-sm font-bold text-slate-700">
                    <CheckCircle2 className="w-4 h-4 text-brand-blue" /> 9:16 Corridor Mode for narrow aisles
                  </li>
                  <li className="flex items-center gap-2 text-sm font-bold text-slate-700">
                    <CheckCircle2 className="w-4 h-4 text-brand-blue" /> Intelligent loitering detection
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="py-20 bg-brand-navy relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Secure Your Logistics Hub
          </h2>
          <p className="text-slate-300 font-medium mb-10 text-lg max-w-2xl mx-auto">
            Contact us to design an intelligent security infrastructure that protects your inventory and streamlines operations.
          </p>
          <button
            onClick={() => triggerQuoteModal('Warehouse Security Consultation')}
